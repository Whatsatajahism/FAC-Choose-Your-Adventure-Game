...
const textNodes = [
    ...
    },
    {
        ...
        options: [
            {
                text: 'Take a single bite of the apple and share the rest 🐿️',
                requiredState: (currentState) => currentState.apple,
                setState: {apple: true, knowledge: true},
                nextText: 3
            },
            {
                text: 'Eat the entire apple, looking directly at the squirrel while you do 👁️👁️🐿️',
                requiredState: (currentState) => currentState.apple,
    ...
    },
    {
        ...
        {
            text: 'You stare at the door and begin to hallucinate food. You reach for what you believe is a vegan burger, but is actually poisonous moss. You sadly die after your first bite.🍔☠️',
    ...
    },
    {
        ...
        options: [
            ...
            {
                text: 'You have been thinking of recipes for the last few hours. You think you can open a community kitchen in this city and you smile, striding towards a new career path.🍜🚶🏽‍♀️',
